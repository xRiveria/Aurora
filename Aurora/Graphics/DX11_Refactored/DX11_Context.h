...
namespace Aurora
{
    ...
    public:
        ...
        void CreateTexture2DFromData(DX11_Texture* texture, const void* sourceData, uint32_t textureWidth, uint32_t textureHeight, DXGI_FORMAT format, uint32_t sampleLevels, uint32_t textureFlags, uint32_t mipSlice);
