// Converts Equirectancular projection texture into a proper cubemap.
...
// This is essentially "inverse-sampling": we reconstruct what the sampling vector would be if we wanted it to 'hit" this particular fragment in a cubemap.
