...
#define TEXSLOT_RENDERER_METALNESS_MAP              TEXSLOT_ONDEMAND_2
#define TEXSLOT_RENDERER_ROUGHNESS_MAP              TEXSLOT_ONDEMAND_3

#define TEXSLOT_RENDERER_SKYHDR_MAP                 TEXSLOT_ONDEMAND_4
#define TEXSLOT_RENDERER_SKYCUBE_MAP                TEXSLOT_ONDEMAND_5

#define TEXSLOT_RENDERER_DEPTHSHADOW_MAP            TEXSLOT_ONDEMAND_6
#define TEXSLOT_RENDERER_SKYCUBE_PREFILTER          TEXSLOT_ONDEMAND_7
#define TEXSLOT_RENDERER_SKYCUBE_IRRADIANCE         TEXSLOT_ONDEMAND_8
#define TEXSLOT_RENDERER_SKYCUBE_BRDF_LUT           TEXSLOT_ONDEMAND_9
...
#define TEXSLOT_RENDERER_AO_MAP                     TEXSLOT_ONDEMAND_13
