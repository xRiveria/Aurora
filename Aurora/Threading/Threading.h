...
namespace Aurora
{
    ...
    {
    public:
        Threading(EngineContext* engineContext);
        
        bool Initialize() override; // Creates our internal resources such as worker threads.
        ...
        */
        ...
        void SingularTaskUnitTest();
        void LoopingTaskUnitTest();
