...
namespace Aurora
{
    ...
    void Entity::LoadModel(const std::string& filePath, const std::string& fileTexture)
    {
        ...
        {
            ImportModel_OBJ(filePath, fileTexture);
        }
    ...
    void Entity::ImportModel_OBJ(const std::string& filePath, const std::string& fileTexture)
    {
        m_MeshComponent.m_BaseTexture = m_EngineContext->GetSubsystem<ResourceCache>()->Load("Hollow_Knight_Albedo.png", fileTexture);
